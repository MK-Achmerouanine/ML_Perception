...
def find_components(edges, max_components=16):
    ...
    while count > 16:
        ...
        dilated_image = np.uint8(dilated_image * 255)
    ...
    while covered_sum < total:
        ...
        for i, c in enumerate(c_info):
            ...
            if new_f1 > f1 or (
                ...
                # print( '{} {} ->  {}  /  {}  ( {} ),  {}  ->  {}  / {}  ( {} ),  {}  -> {} '.format(i, covered_sum, new_sum, total, remaining_frac,
...
def preprocess(img_path):
    ...
    thresh1 = cv2.adaptiveThreshold(
        gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 85, 15)
    ...
    thresh1 = cv2.adaptiveThreshold(
        gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 85, 45)
    # cv2_imshow(thresh1)
    return thresh1
...
def image_to_text(path):
    ...
    text = pytesseract.image_to_string(process_image(path), lang='eng')
